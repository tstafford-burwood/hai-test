# view: hai_master {
#   sql_table_name: `cdph_hai_combined.hai_master`
#     ;;
...
#   dimension: amrfinderplus_amr_genes_spit {
#     type: string
#     sql: SPLIT(${amrfinderplus_amr_genes}, ",")[SAFE_OFFSET(0)] ;;
#   }
...
#     type: string
#     sql: CASE
#           WHEN ${TABLE}.county IS NULL THEN "Blank"
#           WHEN ${TABLE}.county = "" THEN "Blank"
#           ELSE ${TABLE}.county
#           END;;
